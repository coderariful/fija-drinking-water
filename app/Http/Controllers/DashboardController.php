...
class DashboardController extends Controller
{
    ...
    public function userDashboard()
    {
        ...
        return view('user.dashboard', [
            ...
            'jar_sale_today' => Transaction::common()->where('user_id', $user_id)->today()->where('product_type', Product::WATER)->count(),
            'jar_sale_this_month' => Transaction::common()->where('user_id', $user_id)->today()->where('product_type', Product::WATER)->count(),
