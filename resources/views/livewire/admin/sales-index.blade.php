                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        @forelse($sales as $sale)
                            <tr>
                                ...
                                <td class="py-1 text-center" x-data="{edit: false}">
                                ...
                                <td class="py-1">
                                    <button type="button" class="btn btn-danger btn-sm btn-circle" onclick="return confirm('{{trans('Are you sure?')}}') || event.stopImmediatePropagation()" wire:click.prevent="deleteSale({{$sale->id}})">
