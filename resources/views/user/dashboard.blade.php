...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-sm-6">
            <a href="{{route('user.customer.index', ['status' => null])}}">
        ...
        <div class="col-xl-3 col-sm-6">
            <a href="{{route('user.customer.index', ['status' => 'pending'])}}">
        ...
        <div class="col-xl-3 col-sm-6">
            <a href="{{route('user.sales.index', ['day' => 'today'])}}">
        ...
        <div class="col-xl-3 col-sm-6">
            <a href="{{route('user.payments.index', ['day' => 'today'])}}">
        ...
        <div class="col-xl-3 col-sm-6">
            <a href="{{route('user.sales.index', ['day' => 'today', 'product' => 'jar'])}}">
        ...
        @foreach($dispenser as $dispense)
            <div class="col-xl-3 col-sm-6">
                <a href="{{route('user.sales.index', ['product' => $dispense->id])}}">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('user.customer.search')}}" id="customer_search_form">
                        <div class="row justify-content-center">
                            <div class="col-md-6 d-flex">
                                ...
                                <a href="{{route('user.customer.create')}}" class="btn btn-primary ml-3 px-4">Add Customer</a>
                            </div>
                        </div>
                    </form>
                </div>
...
@push('scripts')
    ...
    @include('user.includes.dashboard-js')
@endpush
