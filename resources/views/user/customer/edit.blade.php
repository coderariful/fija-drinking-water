...
@section('title', config('app.name', 'Edit Customer').' | '.$title)
    ...
    <div class="row">
        <div class="col">
            <nav class="breadcrumb justify-content-sm-start justify-content-center text-center text-light bg-dark ">
                ...
                <a class="breadcrumb-item text-white"
                   href="{{ route('user.customer.index') }}">{{__('All Customer')}}</a>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-dark bg-dark">
                ...
                <form class="" action="{{route('user.customer.update', $customer->id)}}" method="POST">
                    @csrf @method("PUT")
                    <div class="card-body">
